...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].start(); // Fungsi untuk menampilkan konfirmasi sebelum menghapus
  ...
  deleteButtons.forEach(function (button) {
    button.addEventListener('click', function (event) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
        ...
        text: "Anda yakin ingin membatalkan permintaan ini?",
        icon: 'warning',
