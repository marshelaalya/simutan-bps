...
.custom-link:hover {
    color: lightblue; /* Ganti dengan warna biru muda sesuai kebutuhan */
}
                    ...
                    var table = $('.yajra-datatable').DataTable({
                        ...
                        ajax: {
                            ...
                            data: function(d) {
                                ...
                                d.supervisor_approval = $('#supervisor_approval_filter').val() || 'pending' || 'approved by admin';
                            }
                        },
                        columns: [
...
var supervisorSelect = $('<select id="supervisor_approval_filter" class="form-select-sm" style="width: 24%; border: 1px solid #1156bf; color:#043277; font-weight: 500;"><option value="">Supervisor Pending</option></select>')
